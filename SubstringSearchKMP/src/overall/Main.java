...
//		}
		...
		// Performance
		// Traversed from 1024 to 4194304 to get 13 set of experiment results, repeat three times
		
		// ............ JAVA JVM Heap space is not enough for 
		// Fixed the bug now TAT
		...
		// try to solve by cast to stack, but failed
//		Experimenter exp = new Experimenter();
//		exp.doSearch(1024, 4194304, "a-z");
	}
	 ...
	 * @throws IOException
	 */
	private static void doSearchAndWriteToFile(String txt, String pat, String algo, BufferedWriter writer) throws IOException{
		if (algo.equals("BF1")) {
	 ...
	 */
	private static void doSearch(int startIndex, int endIndex, String mode, int times) {
		
		System.out.println("RUNNING " + mode);
	
		try {
			BufferedWriter writerBF1 = new BufferedWriter(new FileWriter("BF1_search_" + mode + "_condition2_" + times + ".txt", false));
			BufferedWriter writerBF2 = new BufferedWriter(new FileWriter("BF2_search_" + mode + "_condition2_" + times + ".txt", false));
			BufferedWriter writerKMP1 = new BufferedWriter(new FileWriter("KMP1_search_" + mode + "_condition2_" + times + ".txt", false));
			BufferedWriter writerKMP2 = new BufferedWriter(new FileWriter("KMP2_search_" + mode + "_condition2_" + times + ".txt", false));
		
			writerBF1.write(String.format("%s\t %s\t %s\t %s\t %s\t %s\t %s\t %s\t\n", "", "PATTERN LENGTH", "SEARCH INSPECT TIMES", "CONSTRUCT INSPECT TIMES", "SEARCH TIME(ms)", "CONSTRUCT TIME(ms)", "TOTAL TIME(ms)", "FOUND POSITION"));
			writerBF2.write(String.format("%s\t %s\t %s\t %s\t %s\t %s\t %s\t %s\t\n", "", "PATTERN LENGTH", "SEARCH INSPECT TIMES", "CONSTRUCT INSPECT TIMES", "SEARCH TIME(ms)", "CONSTRUCT TIME(ms)", "TOTAL TIME(ms)", "FOUND POSITION"));
			writerKMP1.write(String.format("%s\t %s\t %s\t %s\t %s\t %s\t %s\t %s\t\n", "", "PATTERN LENGTH", "SEARCH INSPECT TIMES", "CONSTRUCT INSPECT TIMES", "SEARCH TIME(ms)", "CONSTRUCT TIME(ms)", "TOTAL TIME(ms)", "FOUND POSITION"));
			writerKMP2.write(String.format("%s\t %s\t %s\t %s\t %s\t %s\t %s\t %s\t\n", "", "PATTERN LENGTH", "SEARCH INSPECT TIMES", "CONSTRUCT INSPECT TIMES", "SEARCH TIME(ms)", "CONSTRUCT TIME(ms)", "TOTAL TIME(ms)", "FOUND POSITION"));
...
//					String pattern = Generater.generatePattern(txt, i);
	 ...
	 * @throws IOException
	 */
	private static void testAtoZMode(int times) throws IOException {
